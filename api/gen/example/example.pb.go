...
var file_example_example_proto_depIdxs = []int32{
	0, // 0: example.ExampleService.Hello:input_type -> example.HelloRequest
	1, // 1: example.ExampleService.Hello:output_type -> example.HelloResponse
